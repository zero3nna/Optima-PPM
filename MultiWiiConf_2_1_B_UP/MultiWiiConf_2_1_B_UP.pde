...
//    ellipse(-size, -size, size, size);ellipse(+size, -size, size, size);ellipse(0,  +size,size, size);
    ...
    motSlider[2].setPosition(xMot+50,yMot+15);motSlider[2].setHeight(100);motSlider[2].setCaptionLabel("REAR");motSlider[2].show();
    motSlider[1].setPosition(xMot+100,yMot-15);motSlider[1].setHeight(100);motSlider[1].setCaptionLabel("RIGHT");motSlider[1].show();
    motSlider[0].setPosition(xMot,yMot-15);motSlider[0].setHeight(100);motSlider[0].setCaptionLabel("LEFT");motSlider[0].show();
...
//    ellipse(0,  -size,   size,size);ellipse(0,  +size, size, size);ellipse(+size, 0,  size , size );ellipse(-size, 0,  size , size );
    ...
    motSlider[2].setPosition(xMot+50,yMot+75);motSlider[2].setHeight(60);motSlider[2].setCaptionLabel("REAR");motSlider[2].show();
    motSlider[1].setPosition(xMot+100,yMot+35);motSlider[1].setHeight(60);motSlider[1].setCaptionLabel("RIGHT");motSlider[1].show();
    motSlider[3].setPosition(xMot,yMot+35);motSlider[3].setHeight(60);motSlider[3].setCaptionLabel("LEFT");motSlider[3].show();
    motSlider[0].setPosition(xMot+50,yMot-15);motSlider[3].setHeight(60);motSlider[3].setCaptionLabel("FRONT");motSlider[3].show();
...
//   ellipse(-size,  -size, size, size);ellipse(+size,  -size, size, size);ellipse(-size,  +size, size, size);ellipse(+size,  +size, size, size);
    ...
    motSlider[2].setPosition(xMot+90,yMot+75);motSlider[2].setHeight(60);motSlider[2].setCaptionLabel("REAR_R");motSlider[2].show();
    motSlider[1].setPosition(xMot+90,yMot-15);motSlider[1].setHeight(60);motSlider[1].setCaptionLabel("FRONT_R");motSlider[1].show();
    motSlider[3].setPosition(xMot+10,yMot+75);motSlider[3].setHeight(60);motSlider[3].setCaptionLabel("REAR_L");motSlider[3].show();
    motSlider[0].setPosition(xMot+10,yMot-15);motSlider[0].setHeight(60);motSlider[0].setCaptionLabel("FRONT_L");motSlider[0].show(); 
...
//    ellipse(-5-size,-5-size,size,size);ellipse(5+size,-5-size,size,size);ellipse(0,3+size,size,size);
    ...
    motSlider[5].setPosition(xMot+50,yMot+23);motSlider[5].setHeight(50);motSlider[5].setCaptionLabel("REAR");motSlider[5].show();
    motSlider[4].setPosition(xMot+100,yMot-18);motSlider[4].setHeight(50);motSlider[4].setCaptionLabel("RIGHT");motSlider[4].show();
    motSlider[3].setPosition(xMot,yMot-18);motSlider[3].setHeight(50);motSlider[3].setCaptionLabel("LEFT");motSlider[3].show();
    motSlider[2].setPosition(xMot+50,yMot+87);motSlider[2].setHeight(50);motSlider[2].setCaptionLabel("U_REAR");motSlider[2].show();
    motSlider[1].setPosition(xMot+100,yMot+48);motSlider[1].setHeight(50);motSlider[1].setCaptionLabel("U_RIGHT");motSlider[1].show();
    motSlider[0].setPosition(xMot,yMot+48);motSlider[0].setHeight(50);motSlider[0].setCaptionLabel("U_LEFT");motSlider[0].show();
